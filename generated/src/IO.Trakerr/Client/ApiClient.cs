...
namespace IO.Trakerr.Client
{
    ...
    public partial class ApiClient
    {
        ...
        /// with default configuration and base path (https://www.trakerr.io/api/v1).
        /// </summary>
        public ApiClient()
        {
            Configuration = Configuration.Default;
            RestClient = new RestClient("https://www.trakerr.io/api/v1");
        }

        /// <summary>
        /// Initializes a new instance of the <see cref="ApiClient" /> class
        /// with default base path (https://www.trakerr.io/api/v1).
        /// </summary>
